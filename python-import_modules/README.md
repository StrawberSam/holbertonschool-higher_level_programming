...
```
guillaume@ubuntu:~/$ cat add\_0.py
#!/usr/bin/python3
def add(a, b):
...
1 + 2 = 3
guillaume@ubuntu:~/$ cat 0-import\_add.py
\_\_import\_\_("0-add")
guillaume@ubuntu:~/$ python3 0-import\_add.py
guillaume@ubuntu:~/$
```
...
```
guillaume@ubuntu:~/$ cat calculator\_1.py
#!/usr/bin/python3
def add(a, b):
    """My addition function
...
*   Your code should not be executed when imported
```
guillaume@ubuntu:~/$ ./3-infinite\_add.py
0
guillaume@ubuntu:~/$ ./3-infinite\_add.py 79 10
89
guillaume@ubuntu:~/$ ./3-infinite\_add.py 79 10 -40 -300 89
-162
guillaume@ubuntu:~/$
```
...
*   Your code should not be executed when imported
```
guillaume@ubuntu:/tmp$ curl -Lso "hidden\_4.pyc" "https://github.com/hs-hq/0x02.py/raw/main/hidden\_4.pyc"
guillaume@ubuntu:/tmp$ ./4-hidden\_discovery.py | sort
my\_secret\_santa
print\_hidden
print\_school
...
*   Your code should not be executed when imported
```
guillaume@ubuntu:~/$ cat variable\_load\_5.py
#!/usr/bin/python3
a = 98
"""Simple variable
"""

guillaume@ubuntu:~/$ ./5-variable\_load.py
98
guillaume@ubuntu:~/$
```
